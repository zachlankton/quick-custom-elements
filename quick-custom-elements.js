(() => {
    ...
    // debugging helper
      ...
      static get observedAttributes() { return eval( attrs ); }
			constructor() {
				super();
        ...
        this.qce_constructor && this.qce_constructor()
			...
			connectedCallback()     { this.qce_connected    && this.qce_connected();    }
      disconnectedCallback()  { this.qce_disconnected && this.qce_disconnected(); }
      adoptedCallback()       { this.qce_adopted      && this.qce_adopted();      }
